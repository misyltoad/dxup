...
namespace dxup {
  ...
  namespace convert {
    ...
    DXGI_FORMAT declType(D3DDECLTYPE type) {
      ...
      case D3DDECLTYPE_UBYTE4: return DXGI_FORMAT_R8G8B8A8_UNORM;
      case D3DDECLTYPE_SHORT2: return DXGI_FORMAT_R16G16_SNORM;
      case D3DDECLTYPE_SHORT4: return DXGI_FORMAT_R16G16B16A16_SNORM;
